...
export const Login = () => {
    ...
    <div style={{backgroundColor:"white",width:538,height:500,borderRadius:'8px',display:"flex",justifyContent:'center',alignItems:"center",flexDirection:'column'}} >
      ...
      <div style={{color:"#829AB1", marginTop:"2%"}}>Fill in your details below and Log in</div>
        ...
        <div style={{margin:'15px'}}><button style={{fontsize:"25px",background: '#278740',height: '45px',borderRadius: '8px',width:'465.5px',color:'white',borderWidth:0,cursor: 'pointer'}}>Login</button></div>
        <div style={{display:"flex",justifyContent:'center',alignItems:"center",flexDirection:'row'}}>
          <div style={{color:"#829AB1"}}>Don't Haven An Account?</div>
          <div style={{marginLeft:'10px',fontWeight:700,textDecorationLine:'underline',cursor:"pointer"}}> <Link style={{color:"black"}} to={'/Signup'}>Signup Now</Link> </div>
        </div>
      </div>
    </div>
  };